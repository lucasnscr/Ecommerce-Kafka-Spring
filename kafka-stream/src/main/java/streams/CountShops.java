...
import streams.serializer.ShopSerde;
...
public class CountShops {
	...
	public static void main(String [] args) {
	       ...
	       KTable<String, Long>  teste = inputTopic.groupByKey().count(Materialized.<String, Long, KeyValueStore<Bytes, byte[]>>as("count-store"));
